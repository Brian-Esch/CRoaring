...
static_assert(std::is_nothrow_move_constructible<Roaring>::value, "Expected Roaring to be no except move constructable");
static_assert(std::is_nothrow_move_constructible<Roaring64Map>::value, "Expected Roaring64 to be no except move constructable");
